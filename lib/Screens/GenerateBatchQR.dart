...
class GenerateBatchQR extends StatefulWidget {
  static final String id = "GenerateBatchQR";
  @override
  _GenerateBatchQRState createState() => _GenerateBatchQRState();
}

class _GenerateBatchQRState extends State<GenerateBatchQR> {
  List<String> names = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Generate Batch QR Code"),
      ),
      body: Center(
        child: Column(
          children: [
                    ...
                    child: new Scrollbar(
                      child: GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, index) {
                          return Column(
                            children: [
                              QrImage(data: names[index], size: MediaQuery.of(context).size.width*0.3, version: QrVersions.auto,),
